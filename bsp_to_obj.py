...
def obj_from_bsp(bsp_path: str='beta/oddball_b1.bsp', pball_path: str='./pball') -> str:
    """
    ...
    Next lines are a variably sized block of comments defining colors as 0-255 RGB values or RGBA for faces not
